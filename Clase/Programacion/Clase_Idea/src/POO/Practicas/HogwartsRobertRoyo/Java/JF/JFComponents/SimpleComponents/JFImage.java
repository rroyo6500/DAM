...
public class JFImage extends JFComponent {
     ...
     */
    public JFImage(int width, int height, BufferedImage image) {
        super();
     ...
     */
    public JFImage(int width, int height, String imagePath) {
        super();
        setSize(width, height);
        try {
     ...
     * @param image image content to render
     */
    public JFImage(BufferedImage image) {
        super();
        this.image = image;
     ...
     * @param imagePath path of the image file to load
     */
    public JFImage(String imagePath) {
        super();
        try {
            this.image = ImageIO.read(new File(imagePath));
        } catch (IOException e) {
